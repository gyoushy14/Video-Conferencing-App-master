...
function Lobby() {
  ...
  return (
    <section className="bg-[#ECECEC] w-full h-screen pt-10 rounded-xl">
      <div className="w-[450px] bg-white p-4 mx-auto rounded-lg shadow-lg">
        ...
        >
          ...
          <div className="flex space-x-8 mt-8 mx-auto mb-2">
            <button className="rounded-md w-[100px] hover:shadow text-white text-md  hover:border-blue-900 hover:scale-110  border-2 transition-all font-light bg-blue-400 px-4 py-2">
              Join
            </button>
            <button className="rounded-md w-[100px] hover:shadow hover:border-blue-900 hover:scale-110  border-2 transition-all text-md font-light bg-px-4 py-2">
              Cancel
            </button>
          </div>
        </form>
